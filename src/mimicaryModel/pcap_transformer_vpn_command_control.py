...
# SLA Constraints for VPN Command&Control
SLA_THRESHOLDS = {
    "pps_band_pct": (0.20, 0.40),           # ±20–40%
    "mean_iat_band_pct": (0.20, 0.30),      # ±20–30%
    "stdev_iat_max_pct_of_mean": 3.0,       # Up to +200% vs baseline mean IAT
    "stdev_iat_abs_max_ms": 200.0,          # Absolute cap of 200 ms
...
def main():
    parser = argparse.ArgumentParser(description="VPN-Command&Control PCAP Transformer")
