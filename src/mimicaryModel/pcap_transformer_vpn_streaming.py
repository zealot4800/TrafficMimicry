...
# VPN-Streaming Configuration
PACKET_LEN_IMP = 0.40203584
BYTE_COUNTER_IMP = 0.19804912
IAT_IMP = 0.2989859

# SLA Constraints for VPN Streaming
SLA_THRESHOLDS = {
    ...
    "stdev_iat_abs_max_ms": 30.0,           # Absolute cap of 30 ms
    "per_gap_margin_pct": (0.07, 0.12),     # ±7–12%
