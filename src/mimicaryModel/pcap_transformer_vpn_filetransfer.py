...
# SLA Constraints for VPN File Transfer
SLA_THRESHOLDS = {
    "pps_band_pct": (0.30, 0.50),           # ±30–50%
    "mean_iat_band_pct": (0.30, 0.50),      # ±30–50%
    "stdev_iat_max_pct_of_mean": 2.0,       # Up to 2× baseline mean IAT
    "stdev_iat_abs_max_ms": math.inf,       # No practical absolute cap provided
    "per_gap_margin_pct": (0.15, 0.30),     # ±15–30%
    "max_total_stretch_pct": 0.20,          # ≤ +20% (≈ +10–20% band)
}
